...
-- AddForeignKey
ALTER TABLE "Multimedia" ADD CONSTRAINT "Multimedia_ubicacionId_fkey" FOREIGN KEY ("ubicacionId") REFERENCES "Ubicacion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
